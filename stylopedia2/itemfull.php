...
<div class="container bigpadding" style="background:url(preview/nir2.jpg);background-position:center;">
	<section class="row largetoppadding bigbottompadding">
	<h2 class="whitetext bold midbottommargin center">SOME PROJECT TITLE</h2>
...
<div class="container white">
	...
	<div class="four columns sidebar grey">
		<h5 class="blacktext extrabold midbottommargin smalltoppadding">PROJECT BRIEF</h5>
		<p class="meta">
