...
<div class="container">
	...
	<div class="eight columns">
		...
		<ul id="menu">
			...
			<li class="active"><a href="blog.php">NOTES</a>
			<ul>
...
<div class="container bigtoppadding bigbottompadding" style="background:url(img/stripes.png);">
	...
	<div class="eight columns centered">
		<!-- POST TITLE -->
		<a href="blogsingle.php" title="Read Note">
		...
		<p class="center">
			...
			<a class="smallfont greytext" href="blogsingle.php">READ POST</a>
		</div>
		</article>
		<!-- POST TWO -->
		<article class="row blog white">
