...
<div class="container black bigpadding">
	...
	<div class="six columns griditem">
		<img src="preview/g1.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
	...
	<!-- PROJECT TWO -->
	<div class="six columns griditem">
		<img src="preview/g10.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">WEB DESIGN / UI</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">WEBDESIGN <br/> USER INTERFACE </h2>
		</div>
		</a>
	</div>
	<!-- PROJECT THREE -->
	<div class="alpha six columns griditem">
		<img src="preview/g3.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">IDENTITY / ANIMATION / UX</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">IDENTITY <br/> ANIMATION <br/> USER EXPERIENCE</h2>
		</div>
		</a>
	</div>
	<!-- PROJECT FOUR -->
	<div class="six columns griditem">
		<img src="preview/g4.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">WEB DESIGN / UI/ UX</h5>
	...
	<!-- PROJECT FIVE -->
	<div class="alpha six columns griditem">
		<img src="preview/g5.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">IDENTITY / UI</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">IDENTITY <br/> USER INTERFACE </h2>
		</div>
		</a>
	</div>
	<!-- PROJECT SIX -->
	<div class="six columns griditem">
		<img src="preview/g6.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">WEB DESIGN / SOCIAL MEDIA</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">WEBDESIGN <br/> SOCIAL MEDIA </h2>
		</div>
		</a>
	</div>
	<!-- PROJECT SEVEN -->
	<div class="alpha six columns griditem">
		<img src="preview/g7.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">360 SOLUTION</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">360 SOLUTION</h2>
		</div>
		</a>
	</div>
	<!-- PROJECT EIGHT -->
	<div class="six columns griditem">
		<img src="preview/g8.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">BRANDING / WEB DESIGN / UX</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">BRANDING <br/> WEBDESIGN <br/> USER EXPERIENCE </h2>
		</div>
		</a>
	</div>
	<!-- PROJECT NINE -->
	<div class="alpha six columns griditem">
		<img src="preview/g9.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">WEB DESIGN / UI/ UX</h5>
	...
	<!-- PROJECT TEN -->
	<div class="six columns griditem">
		<img src="preview/g2.jpg" alt="griditem"/>
		<a href="../itembasic.php" title="CLick To View Project">
		<div class="gridinfo">
			<h3 class="whitetext extrabold bigtoppadding center">PROJECT TITLE</h3>
			<h5 class="whitetext center">WEB DESIGN / ANIMATION / PRINT MEDIA</h5>
			<span class="smallfont space">VIEW PROJECT</span>
		</div>
		<div class="gridblack">
			<h2 class="whitetext">WEBDESIGN <br/> ANIMATION <br/> PRINT MEDIA</h2>
		</div>
		</a>
	</div>
	</section>
