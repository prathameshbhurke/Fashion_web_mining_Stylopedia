...
<div class="black bigpadding eighteen column">
<div class="black bigtoppadding"></div>
<section class="row">
<h4 class="text whitetext extrabold midbottommargin">FLICKER FEEDS</h4>
 <div style="width:100%;"> 
 <div style="float:left; width:20%;">
	
	<h5 class="text whitetext extrabold midbottommargin">PRADA</h5>
	<?php
...
$params = array(
    ...
    'api_key' => $key,
    'text' => 'Prada', // Our search term
    'media' => 'photos',
    'per_page' => 8 // We only want 20 results
);
...
<div style="float:left; width:20%;">
<h5 class="text whitetext extrabold midbottommargin">LOUIS VUITTON</h5>
<?php
// Store some basic information that you need to reference
$apiurl = 'http://api.flickr.com/services/rest/?';
$key = '9f275087e222ee395c92662437bf84a2'; // Replace with your own key
...
$params = array(
    'method' => 'flickr.photos.search',
    'api_key' => $key,
    'text' => 'Louis Vuitton', // Our search term
    'media' => 'photos',
    'per_page' => 8 // We only want 20 results
);
...
<h5 class="text whitetext extrabold midbottommargin">DOLCE AND GABBANA</h5>
<?php
// Store some basic information that you need to reference
$apiurl = 'http://api.flickr.com/services/rest/?';
$key = '9f275087e222ee395c92662437bf84a2'; // Replace with your own key
...
$params = array(
    'method' => 'flickr.photos.search',
    'api_key' => $key,
    'text' => 'Dolce and Gabbana', // Our search term
    'media' => 'photos',
    'per_page' => 8 // We only want 20 results
);
...
<div style="float:right; width:20%;">
<h5 class="text whitetext extrabold midbottommargin">AVON</h5>
<?php
// Store some basic information that you need to reference
$apiurl = 'http://api.flickr.com/services/rest/?';
$key = '9f275087e222ee395c92662437bf84a2'; // Replace with your own key
...
<div style="float:right; width:20%;">
<h5 class="text whitetext extrabold midbottommargin">GUCCI</h5>
<?php
// Store some basic information that you need to reference
$apiurl = 'http://api.flickr.com/services/rest/?';
$key = '9f275087e222ee395c92662437bf84a2'; // Replace with your own key
...
?>
	...
	<!--<div class="six columns center"><iframe width="800" height="500" style="border:none;" src="http://output65.rssinclude.com/output?type=iframe&amp;id=862010&amp;hash=4e207b11df48790bb2b29a251a53cff0"></iframe></div>
	<div class="six columns center"><iframe width="800" height="650" style="border:none;" src="http://output56.rssinclude.com/output?type=iframe&amp;id=862734&amp;hash=f7ca07abf882676bb6912b480d1751c9"></iframe></div>
	<div class="six columns center"><iframe width="800" height="650" style="border:none;" src="http://output88.rssinclude.com/output?type=iframe&amp;id=862004&amp;hash=8508ba377d67a14731ca923030a7b0bc"></iframe></div> -->
